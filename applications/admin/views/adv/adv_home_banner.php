<?php
$this->breadcrumbs = array('广告管理','首页通栏');
?>
<style type="text/css">
...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		...
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-edit"></i>首页通栏</h2>
		</div>
		<?php }?>
		<div class="box-content">
			...
			<?php }?>
			<form class="form-horizontal" method="post" action="<?php echo $this->createUrl('adv/homebanner',array('op'=>'addHomeBanner'));?>" enctype="multipart/form-data">
				<fieldset>
				  <div class="control-group" id="show_addEffect">
				      <label class="control-label"></label>
				      <div class="controls">
						  <a href="javascript:;" id="addEffect" class="btn">+添加通栏广告</a>
				      </div>
				   </div>
				  
				  <dl style="border-top:1px #999999 dotted"></dl>
				  	首页通栏广告列表操作（最大上限为8张图片）
