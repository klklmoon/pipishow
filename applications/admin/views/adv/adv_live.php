<?php
$this->breadcrumbs = array('广告管理','直播间广告');
?>

<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-edit"></i>直播间广告</h2>
			<div class="box-icon">
				<a href="javascript:void(0);" class="btn btn-setting btn-round" title="添加直播间广告"><i class="icon-plus"></i></a>
...
<div class="modal hide fade span3" id="global_video_edit" style="left:40%;">
	...
	<div class="modal-body" id="global_chatword_edit_body">
		<form class="form-horizontal" method="post" action="<?php echo $this->createUrl('adv/liveAdv',array('op'=>'addLiveAdv'));?>" enctype="multipart/form-data" id="myForm">
