<?php
$this->breadcrumbs = array('运营管理','皮蛋消费记录');
...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-user"></i> <?php echo $types[$condition['type']];?>消费记录</h2>
		</div>
		...
		<div class="box-content">
			...
			<table class="table table-bordered" id="gift_list_table">
				...
				<tbody>
				  	...
				  	<tr>
						<td><?php echo date('Y-m-d H:i:s',$uinfo['consume_time']);?></td>
						...
						<td><?php echo $uinfo['cbalance']?></td>
						<td><?php echo $uinfo['num']?></td>
						<td>
							<?php if(isset($sourcelist[$uinfo['source']]['name'])) {echo $sourcelist[$uinfo['source']]['name'] ;}else{echo $uinfo['source'];};?>
						</td>
						<td><?php 
