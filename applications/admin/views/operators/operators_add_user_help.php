<?php
$this->breadcrumbs = array('运营工具','添加用户帮助');
?>
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<?php if(!$this->isAjax){?>
		<div data-original-title="" class="box-header well">
			<h2><i class="icon-edit"></i> 添加用户帮助</h2>
		</div>
		<?php }?>
		<div class="box-content">
			...
			<form class="form-horizontal" id="purview_add" action="<?php echo $this->createUrl('operators/adduserhelp',array('op'=>'addUserHelp'));?>" method="post">		
				<fieldset>
					<div class="control-group">
						<label class="control-label">所属栏目</label>				
						<div class="controls">
							<?php
								echo CHtml::listBox('userhelp[name]', $subForum, $allSubForum,array('size'=>1,'empty'=>'-请选择-','class'=>'input-small'));
							?>
						</div>
				  	</div> 
					<div class="control-group">
						...
						<div class="controls">
							<?php 
								...
								echo CHtml::textField('userhelp[title]',$v1,array('class'=>'input-large'));
							?>
						</div>
				  	</div> 
			  	 	...
			  	 	<div class="control-group">
						...
						<div class="controls">
							<?php 
								...
								echo CHtml::textArea('userhelp[content]',$v2,array('class'=>'cleditor'));
							?>
						</div>
					</div>
					...
					<div class="form-actions">
						...
						if(isset($info['thread_id'])){
							echo CHtml::hiddenField('userhelp[thread_id]',$info['thread_id']);	
...
<script type="text/javascript">
    CKEDITOR.replace('userhelp[content]',{
