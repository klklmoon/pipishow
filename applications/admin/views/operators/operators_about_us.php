...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<h2>关于我们列表管理</h2>
			<div class="box-icon">
				<a class="btn btn-round" href="#" title="添加关于我们"><i class="icon-plus"></i></a>
			</div>
		</div>
		<div class="box-content">
			<form class="form-horizontal" id="ursearch" action="<?php echo $this->createUrl('operators/aboutus');?>" method="post">
			  <fieldset>
...
$(function() {
	...
	$(".icon-plus").click(function(e){
		$.ajax({
			type:'post',
			url:"<?php echo $this->createUrl('operators/addaboutus');?>",
			dataType:'html',
	...
	$(".box-content .icon-remove").click(function(e){
		...
		if(threadId){
			$.ajax({
				...
				url:"<?php echo $this->createUrl('operators/addaboutus');?>",
				dataType:'html',
				data:{'threadId':threadId,'sub_forum':subForum,'op':'delAboutUs'},
				success:function(msg){
					if(msg == 1){
