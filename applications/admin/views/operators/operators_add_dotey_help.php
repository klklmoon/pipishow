<?php
$this->breadcrumbs = array('运营工具','添加主播帮助');
?>
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<?php if(!$this->isAjax){?>
		<div data-original-title="" class="box-header well">
			<h2><i class="icon-edit"></i> 添加主播帮助</h2>
		</div>
		<?php }?>
		<div class="box-content">
			...
			<form class="form-horizontal" id="purview_add" action="<?php echo $this->createUrl('operators/adddoteyhelp',array('op'=>'addDoteyHelp'));?>" method="post">		
				<fieldset>
					<div class="control-group">
						<label class="control-label">所属栏目</label>				
						<div class="controls">
							<?php
								echo CHtml::listBox('doteyhelp[name]', $subForum, $allSubForum,array('size'=>1,'empty'=>'-请选择-','class'=>'input-small'));
							?>
						</div>
				  	</div> 
					<div class="control-group">
						...
						<div class="controls">
							<?php 
								...
								echo CHtml::textField('doteyhelp[title]',$v1,array('class'=>'input-large'));
							?>
						</div>
				  	</div> 
			  	 	...
			  	 	<div class="control-group">
						...
						<div class="controls">
							<?php 
								...
								echo CHtml::textArea('doteyhelp[content]',$v2,array('class'=>'cleditor'));
							?>
						</div>
					</div>
					...
					<div class="form-actions">
						...
						if(isset($info['thread_id'])){
							echo CHtml::hiddenField('doteyhelp[thread_id]',$info['thread_id']);
...
<script type="text/javascript">
    CKEDITOR.replace('doteyhelp[content]',{
