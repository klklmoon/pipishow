<?php
$this->breadcrumbs = array('用户管理','用户点歌查询');
?>
<style type="text/css">
				  ...
				  <tbody>
				  	...
				  	<?php 
				  		foreach($records['list'] as $r){
				  			if(!isset($records['userInfos'][$r['uid']]))
				  				continue;
				  			if(!isset($records['doteyInfos'][$r['to_uid']]))
				  				continue;
				  	?>
				  	<tr>
...
<script>
var actionUrl = "<?php echo $this->createUrl('user/vodquery');?>";							
$(function(){
