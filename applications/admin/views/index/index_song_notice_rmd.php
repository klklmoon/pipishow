<?php
$this->breadcrumbs = array('首页管理','唱区公告推荐');
?>
<style type="text/css">
...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		...
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-edit"></i>唱区公告推荐</h2>
			<div class="box-icon">
				<a href="#" class="btn btn-setting btn-round" title="添加唱区公告推荐"><i class="icon-plus-sign"></i></a>
			</div>
		</div>
		<?php }?>
		
		<div class="box-content">
			<form class="form-horizontal" method="post" action="<?php echo $this->createUrl('index/songnoticermd',array('op'=>'addSongNoticeRmd'));?>" enctype="multipart/form-data">
				<fieldset>
					<?php if($info){?>
...
$(document).ready(function(){
	...
	$("dt .icon-remove").click(function(){
		...
		if(operateId){
			$.ajax({
				type:'post',
				url:'<?php echo $this->createUrl('index/songnoticermd');?>',
				dataType:'html',
