<?php
$this->breadcrumbs = array('首页管理','新秀主播版块');
?>
<style type="text/css">
...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		...
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-edit"></i>新秀主播版</h2>
		</div>
		<?php }?>
		<div class="box-content">
			...
			<?php }?>
			<form class="form-horizontal" method="post" action="<?php echo $this->createUrl('index/sidermd',array('op'=>'addSideRmd'));?>" enctype="multipart/form-data">
				<fieldset>
				...
				<dl style="border-top:2px #999999 solid"></dl>
				 <div class="control-group">
				  ...
				  <div class="control-group" style="display:none;" id="show_addEffect">
				      ...
				      <div class="controls">
						  <a href="javascript:;" id="addEffect" class="btn">+添加到侧栏一</a>
				      </div>
				   </div>
