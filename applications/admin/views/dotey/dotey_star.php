<?php
$this->breadcrumbs = array('主播管理','主播星探');
?>
<style type="text/css">
...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		...
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-edit"></i>主播星探列表</h2>
			<div class="box-icon">
				<!-- <a href="#" class="btn btn-setting btn-round" title="新增主播星探"><i class="icon-plus-sign"></i></a> -->
			</div>
		</div>
		<?php }?>
...
$(document).ready(function(){
	...
	$('.auth_stauts').click(function(e){
		...
		if(uid){
			$.ajax({
				url:"<?php echo $this->createUrl('dotey/star'); ?>",
				dataType:'html',
				type:'post',
