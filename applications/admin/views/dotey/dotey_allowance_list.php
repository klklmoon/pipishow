<?php
$this->breadcrumbs = array('主播管理','才艺补贴');
$types = $this->getAwardType();
?>
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-user"></i> 才艺补贴列表</h2>
			<div class="box-icon">
				<a href="#" class="btn btn-setting btn-round" title="新增才艺补贴"><i class="icon-plus-sign"></i></a>
			</div>
		</div>
		
		<div class="box-content">
			<form class="form-horizontal" id="ursearch" action="<?php echo $this->createUrl('dotey/allowance');?>" method="post">
				<fieldset>
		...
		if(confirm('是否撤消该才艺补贴')){
			...
			if(type >= 0 && recordId){
				$.ajax({
					...
					type:'post',
					dataType:'text',
					data:{'type':type,'recordId':recordId,'op':'unAllowance'},
					success:function(msg){
						if(msg == 1){
