			...
			<table class="table table-bordered" id="gift_list_table">
				...
				<tbody>
				  	...
				  	<tr>
						...
						<td><?php echo date('Y-m-d H:i:s',$uinfo['live_time']);?></td>
						<td><?php echo date('Y-m-d H:i:s',$uinfo['end_time']);?></td>
						<td>
							<?php 
								$total = isset($sessStatInfo[$uinfo['archives_id']]['total'])?$sessStatInfo[$uinfo['archives_id']]['total']:'';
								echo $total;
							?>
						</td>
						<td>
							<?php 
								$create_time = isset($sessStatInfo[$uinfo['archives_id']]['create_time'])?$sessStatInfo[$uinfo['archives_id']]['create_time']:'';
								if($create_time){
									echo date('Y-m-d H:i',$create_time);
								}
							?>
						</td>
						<td>
							<?php 
								$avg = isset($sessStatInfo[$uinfo['archives_id']]['avg'])?$sessStatInfo[$uinfo['archives_id']]['avg']:'';
								echo $avg;
							?>
						</td>
						<td>
						...
						<td>
							<?php
								if(isset($archivePv[$uinfo['archives_id']])){
									echo $archivePv[$uinfo['archives_id']]['pv'];
								}else{
									echo 0;
								}
							?>
