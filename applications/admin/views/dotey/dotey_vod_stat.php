<?php
$this->breadcrumbs = array('主播管理','主播点歌统计');
?>
			...
			<form class="form-horizontal" id="ursearch" action="" method="post">
			  <fieldset>
				<div class="control-group">
				  	...
				  	<span>点歌时间:</span>
				  	<?php echo CHtml::textField('vod[s_update_time]',isset($condition['s_update_time'])?$condition['s_update_time']:'',array('class'=>'input-small'));?>至
				  	<?php echo CHtml::textField('vod[e_update_time]',isset($condition['e_update_time'])?$condition['e_update_time']:'',array('class'=>'input-small'));?>
			...
			<table class="table table-bordered" id="gift_list_table">
				  ...
				  <tbody>
				  	...
				  	<tr>
				  		...
				  		<td><a class="btn" title="查看明细" href="<?php echo $this->createUrl('dotey/vodquery',array('to_uid'=>$r['to_uid']));?>"><li class="icon-list"></li></a></td>
				  	</tr>
				  	<?php }?>
				  	<tr>
				  		<td colspan="8">
...
<script>
var actionUrl = "<?php echo $this->createUrl('dotey/vodstat');?>";							
$(function(){
	$('#vod_s_update_time').click(function(){
		WdatePicker({'dateFmt':'yyyy-MM-dd HH:mm:ss'});
	});
	$('#vod_e_update_time').click(function(){
		WdatePicker({'dateFmt':'yyyy-MM-dd HH:mm:ss'});
	});
