<?php
$this->breadcrumbs = array('主播管理','新增主播星探');
?>
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<?php if(!($this->isAjax)){?>
		<div class="box-header well" data-original-title="">
			<h2><i class="icon-edit"></i> 新增主播星探</h2>
		</div>
		<?php }?>
		<div class="box-content">
			...
			<?php }?>
			<form class="form-horizontal" action="<?php echo $this->createUrl('dotey/addstar',array('op'=>'addProxy'));?>" method="post" enctype="multipart/form-data">
				<fieldset>
				  ...
				  <div class="form-actions">
				  	...
				  	<?php }?>
				  	<?php echo CHtml::hiddenField('form[type]',DOTEY_MANAGER_STAR);?>
...
$(function(){
	...
	$("#valid_dotey_info").click(function(){
		...
		if(doteyName){
			$("#valid_dotey_info_noty").html("").hide();
			$.ajax({
				url:"<?php echo $this->createUrl("dotey/addstar");?>",
				type:"post",
				dataType:"text",
