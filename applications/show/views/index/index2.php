...
$doteyInfos = $this->viewer['doteyInfo'];
$siteStars = $this->viewer['siteStars'];
$bannels = array();
if (isset($this->viewer['operate'][CATEGORY_INDEX_BANNER])) {
	$bannels = $this->viewer['operate'][CATEGORY_INDEX_BANNER];
}
	...
	<div class="w1000 topbox-con">
		<div class="fleft topbox-l">
			...
			<ul class="area-banner">
				...
				<li><a class="jukebtn"
					href="<?php $this->getTargetHref('index.php?r=channel/songs')?>"
					target="<?php echo $this->target?>">
	            		<?php echo $themeChannel[CHANNEL_THEME_SONG]['sub_name']?>
	            	</a></li>
			</ul>
			<dl class="area-con">
				<dt>等级</dt>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=channel/category&rank=1#doteyData')?>"
						target="<?php echo $this->target?>">皇冠</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=channel/category&rank=2#doteyData')?>"
						target="<?php echo $this->target?>">钻石</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=channel/category&rank=3#doteyData')?>"
						target="<?php echo $this->target?>">红心</a>
				</dd>
			</dl>
			<dl class="area-con">
				<dt>地域</dt>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=channel/category&area='.$categoryChannel[CHANNEL_AREA_SOUTH]['sub_channel_id'].'#doteyData')?>"
						target="<?php echo $this->target?>"><?php echo $categoryChannel[CHANNEL_AREA_SOUTH]['sub_name']?></a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=channel/category&area='.$categoryChannel[CHANNEL_AREA_NORTH]['sub_channel_id'].'#doteyData')?>"
						target="<?php echo $this->target?>"><?php echo $categoryChannel[CHANNEL_AREA_NORTH]['sub_name']?></a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=channel/category&area='.$categoryChannel[CHANNEL_AREA_JZH]['sub_channel_id'].'#doteyData')?>"
						target="<?php echo $this->target?>"><?php echo $categoryChannel[CHANNEL_AREA_JZH]['sub_name']?></a>
				</dd>
			</dl>
			<dl class="area-con">
				<dt>活动</dt>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=activities/firstchargegifts')?>"
						target="<?php echo $this->target?>">首充送礼</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=activities/happySaturday')?>"
						target="<?php echo $this->target?>">快乐周六</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=activities/giftstar')?>"
						target="<?php echo $this->target?>">礼物之星</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=activities/guardangel')?>"
						target="<?php echo $this->target?>">守护天使</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=activities/happybirthday')?>"
						target="<?php echo $this->target?>">生日快乐</a>
				</dd>				
			</dl>
            ...
            <dl class="area-con">
				...
				<dd>
					<a
						href="<?php $this->getTargetHref( Yii::app()->params['letian_game']['host'] . '/gp/html/LuckSofa.html')?>"
						title="幸运沙发" target="<?php echo $this->target?>">幸运沙发</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref( Yii::app()->params['letian_game']['host'] . '/gp/html/BreakEggs.html')?>"
						title="砸金蛋" target="<?php echo $this->target?>">砸金蛋</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref(Yii::app()->params['letian_game']['host'] . '/gp/html/TreasureBox.html');?>"
						title="开心宝箱" target="<?php echo $this->target?>">开心宝箱</a>
				</dd>
				<dd>
					<a
						href="<?php $this->getTargetHref('index.php?r=index/gameRedirect&game=jiangshenglu&uid='.$this->getUserJsonAttribute('uid',false,true));?>"
						title="将神怒" target="<?php echo $this->target?>">将神怒</a>
				</dd>
				<!-- 
				<dd>
					<a
						href="index.php?r=index/gameRedirect&game=zuixiyou&uid=<?php $this->getUserJsonAttribute('uid',false,true) ?>"
						title="醉西游记" target="<?php echo $this->target?>" title="醉西游记"
						target="<?php echo $this->target?>">醉西游记</a>
				</dd>
				<dd>
					<a
						href="index.php?r=index/gameRedirect&game=shengxiandao&uid=<?php $this->getUserJsonAttribute('uid',false,true) ?>"
						title="醉西游记" target="<?php echo $this->target?>" title="神仙道"
						target="<?php echo $this->target?>">神仙道</a>
				</dd>
				<dd>
					<a
						href="index.php?r=index/gameRedirect&game=xiaobaoshengzhi&uid=<?php $this->getUserJsonAttribute('uid',false,true) ?>"
						title="小宝升职" target="<?php echo $this->target?>">小宝升职</a>
				</dd>
				<dd>
					<a
						href="index.php?r=index/gameRedirect&game=longjiang&uid=<?php $this->getUserJsonAttribute('uid',false,true) ?>"
						title="龙将" target="<?php echo $this->target?>">龙将</a>
				</dd>
				-->
			</dl>
            <?php endif;?>
		...
		<div class="fleft topbox-m">
			...
			<div class="mbox-con">
            	<?php
					if ($this->viewer['topSendGift']) :
				?>
	            <ul>
	            	<?php
						foreach ($this->viewer['topSendGift'] as $topSendGift) :
							$archiveHref = '/' . $topSendGift['d_uid'];
							$archiveGiftInfo = $topSendGift['gift_num'] . '个' . $topSendGift['gift_name'] . '&nbsp;<img width="20px" height="20px" src="' . $this->userService->getUploadUrl() . 'gift/' . $topSendGift['picture'] . '" />';
					?>
	            	 <li><span><?php echo $topSendGift['time']?> </span> <a
						href="<?php $this->getTargetHref($archiveHref,true,false)?>"
						title="<?php echo $topSendGift['nickname']?>"
						class="givename pink" target="<?php echo $this->target?>"><?php echo $topSendGift['nickname']?></a>送给
						<a href="<?php $this->getTargetHref($archiveHref,true,false)?>"
						class="givename pink" title="<?php $topSendGift['d_nickname']?>"
						target="<?php echo $this->target?>"><?php echo $topSendGift['d_nickname']?></a>
		...
		<div class="fleft topbox-r">
			<div id="Rflash" class="rflash">
				<div class="rflash-bd">
					<ul>
                	<?php
						$hasShowCase = isset($this->viewer['operate'][CATEGORY_INDEX_SHOWCASE]);
						if ($hasShowCase) :
							foreach ($this->viewer['operate'][CATEGORY_INDEX_SHOWCASE] as $showcase) :
								$showcase['piclink'] = $operateUrl . $showcase['piclink'];
								
					?>
                    	<li><a
							href="<?php $this->getTargetHref($showcase['textlink'])?>"
							title="<?php echo $showcase['subject']?>"
							target="<?php echo $this->target?>"><img
								src="<?php echo $showcase['piclink']?>"></a></li>
                    <?php
							endforeach;									
           		 		endif;
					?>
				...
				<div class="rflash-hd clearfix">
					...
					<ul class="fleft">
                		<?php
							if ($hasShowCase) :
								foreach ($this->viewer['operate'][CATEGORY_INDEX_SHOWCASE] as $key => $showcase) :
						?>
			...
			<div class="notice">
				...
				<ul class="notice-list">
                 <?php
								$hasNewNotice = isset($this->viewer['operate'][CATEGORY_INDEX_NEWSNOTICE]);
								if ($hasNewNotice) :
									foreach ($this->viewer['operate'][CATEGORY_INDEX_NEWSNOTICE] as $notice) :
																			
				?>  
                	<li><a
						href="<?php $this->getTargetHref($notice['textlink'])?>"
						title="<?php echo $notice['subject']?>"
						target="<?php echo $this->target?>"><?php echo $notice['subject']?></a></li>
	            <?php
																		endforeach
																		;
...
<div class="w1000 clearfix">
	<div class="fleft content-l">
		...
		<div class="anchor">
			<h3 class="seting-h clearfix">
				<p class="fleft seting-menu clearfix">
					<a class="onlive" href="javascript:void(0);" title="正在直播"><i
						class="banericon"></i> <span class="fleft pink">正在直播</span></a> <a
						class="attented setover" href="javascript:void(0);" title="我关注的">我关注的</a>
					<a class="managed" href="javascript:void(0);" title="管理的">管理的</a> <a
						class="looked" href="javascript:void(0);" title="看过的">看过的</a>
				</p>

				<a id="allmanaged" 
					href="<?php $this->getTargetHref($this->createUrl('account/manage'),true,false);?>"
					class="fright more" title="全部管理"
					target="<?php echo $this->target?>">全部管理</a> <a id="allattented" 
			...
			<?php
					$living = $this->archiveService->getLivingArchives(Yii::app()->user->id,true,$this->isLogin);
					$this->archiveService->addTodayRecommandForArchives($living,Yii::app()->user->id,true,$this->isLogin);
		...
		<div class="anchor">
			<h3 class="clearfix">
				...
				<p class="fleft"></p>
				<a
					href="<?php $this->getTargetHref('index.php?r=channel/category&status=2#doteyData')?>"
					class="fright more" title="更多" target="<?php echo $this->target?>">更多</a>
			</h3>
            <?php
												$willLive = $this->archiveService->getWillLiveArchives(Yii::app()->user->id, true, $this->isLogin);
												$this->archiveService->addStarSingerForArchives($willLive);
	...
	<div class="fright content-r">
		<?php 
			...
			if(!isset($birthdayArchives) || empty($birthdayArchives))
			{
				$birthdayArchives=$happyBirthdayService->getBirthdayArchives();
			}
			$todayBirthdayArchives=$birthdayArchives['todayBirthdayArchives'];
			$willBirthdayArchives=$birthdayArchives['willBirthdayArchives'];
		...
		<div class="rightcon relative">
			...
			<?php
				if(count($todayBirthdayArchives)>0):
					$this->channelDoteySort->buildLiveArchives($todayBirthdayArchives,Yii::app()->user->id,0,true,true);

					foreach ($todayBirthdayArchives as $doteyRow):
						$doteyInfo=$this->userService->getUserFrontsAttributeByCondition($doteyRow['uid'],true,true);
			...
			?>
				<dl class="conbox-list birthList">
					<dt>
						<a href="<?php echo $this->getTargetHref("/".$doteyRow['uid']);?>"
							...
							>
						</a> <a class="attent <?php echo $attentTionClass?>"
							href="javascript:void(0);" title="关注"
							onclick="$.User.<?php echo $jsMethod?>('<?php echo $doteyRow['uid'];?>',this,'single');"></a>
					</dt>
					<dd>
						<a href="<?php echo $this->getTargetHref("/".$doteyRow['uid']);?>"
							title="<?php echo $doteyInfo['nk'];?>"
							target="<?php echo $this->target?>"><?php echo $doteyInfo['nk'];?></a>
				...
				<?php
					...
					if(count($willBirthdayArchives)>0):
						$birthdayList=array();
						foreach ($willBirthdayArchives as $archivesRow){
							$birthdayList[$archivesRow['uid']]=$archivesRow['sbirthday'];
						}
						$willBirthdayArchives=$this->channelDoteySort->buildLiveArchives($willBirthdayArchives,Yii::app()->user->id,0,true,true);
				?>
				...
				?>
					<li><a
						...
						<img 
						 ...
						 <span
							class="btmtext"><?php echo $doteyInfo['nk'];?></span> <span
							class="btmtext btmdate"><?php echo $birthdayList[$doteyRow['uid']];?></span>
					</a> <a class="attent <?php echo $attentTionClass?>"
						href="javascript:void(0);" title="关注"
						onclick="$.User.<?php echo $jsMethod?>('<?php echo $doteyRow['uid'];?>',this,'single');"></a></li>
					<?php
						endforeach;
					?>
				</ul>
		...
		<?php endif;?>
   		...
   		<?php
					$hasActivity = isset($this->viewer['operate'][CATEGORY_INDEX_ACTIVITYRECOMMAND]);
					if ($hasActivity) :
						?>
    	<div class="rightcon">
			<h4>
        	...
        	<?php
						$i = 0;
						foreach ($this->viewer['operate'][CATEGORY_INDEX_ACTIVITYRECOMMAND] as $activity) :
							$activity['piclink'] = $operateUrl . $activity['piclink'];
		...
		<div class="rightcon relative">
			<h4>
				...
				<p class="tip-text relative">
					<em>?</em> <span class="tipcon">
                     <?php echo $operateService->getIndexRightDataForStarDotey()?>
                    </span>
				</p>
			</h4>
			<div class="conbox">
            <?php
						$stars = $this->viewer['finalStarDotey'];
						if ($stars) :
							$topStar = array_shift($stars);
							$attentTionClass = $topStar['is_attention'] ? 'cancelatt' : '';
							$jsMethod = $topStar['is_attention'] ? 'cacnelAttentionUser' : 'attentionUser';
							$archivesHref = '/' . $topStar['uid'];
							?>
            	<dl class="conbox-list">
					<dt>
						<a href="<?php $this->getTargetHref($archivesHref,true,false)?>"
							...
							href="javascript:void(0)" title="关注"
							onclick="$.User.<?php echo $jsMethod?>('<?php echo $topStar['uid']?>',this,'single');"></a>
					</dt>
					<dd>
						<a href="<?php $this->getTargetHref($archivesHref,true,false)?>"
							title="<?php echo $topStar['nickname']?>"
             ...
             <?php
						if ($stars) :
							foreach ($stars as $star) :
								$attentTionClass = $star['is_attention'] ? 'cancelatt' : '';
								$jsMethod = $star['is_attention'] ? 'cacnelAttentionUser' : 'attentionUser';
								$archivesHref = '/' . $star['uid'];
								?>
                	<li><a
						href="<?php $this->getTargetHref($archivesHref,true,false)?>"
						title="<?php echo $star['nickname']?>"
						target="<?php echo $this->target?>"> <span><img
								src="<?php echo Yii::app()->params->images_server['url'];?>/default/avatar/avatar_default_small.png"
								data-original="<?php echo $star['small_avatar']?>"></span> <span
							class="btmtext"><?php echo $star['nickname']?></span>
					</a> <a class="attent  <?php echo $attentTionClass?>"
						href="javascript:void(0)" title="关注"
						onclick="$.User.<?php echo $jsMethod?>('<?php echo $star['uid']?>',this,'single');"></a>
					</li>
    		<?php
							endforeach
							;
		...
		<p class="rightcon-btm"></p>
					...
					if ($this->viewer['finalRookieDotey']) :
						?>
        ...
        <div class="rightcon relative">
			<h4>
				...
				<p class="tip-text relative">
					<em>?</em> <span class="tipcon">
                <?php echo $operateService->getIndexRightDataForPookieDotey()?>
               </span>
				</p>
			</h4>
			<div class="conbox">
         <?php
						foreach ($this->viewer['finalRookieDotey'] as $new) :
							$attentTionClass = $new['is_attention'] ? 'cancelatt' : '';
							$jsMethod = $new['is_attention'] ? 'cacnelAttentionUser' : 'attentionUser';
							$archivesHref = '/' . $new['uid'];
							?>   
            	<dl class="conbox-list">
					<dt>
						<a href="<?php $this->getTargetHref($archivesHref,true,false)?>"
							...
							href="javascript:void(0)" title="关注"
							onclick="$.User.<?php echo $jsMethod?>('<?php echo $new['uid']?>',this,'single');"></a>
					</dt>
					<dd>
						<a href="<?php $this->getTargetHref($archivesHref,true,false)?>"
							title="<?php echo $new['nickname']?>"
		...
		<p class="rightcon-btm"></p>
         ...
         <div class="rightcon relative">
			<h4>
				...
				<p class="tip-text relative">
					<em>?</em> <span class="tipcon">
                    <?php echo $operateService->getIndexRightDataForNewDotey()?>
                    </span>
				</p>
			</h4>
			<div class="conbox">
         <?php
						foreach ($this->viewer['newJoinDotey'] as $join) :
							$attentTionClass = $new['is_attention'] ? 'cancelatt' : '';
							$jsMethod = $join['is_attention'] ? 'cacnelAttentionUser' : 'attentionUser';
							$archivesHref = '/' . $join['uid'];
							?>   
            	<dl class="conbox-list">
					<dt>
						<a href="<?php $this->getTargetHref($archivesHref,true,false)?>"
							...
							href="javascript:void(0)" title="关注"
							onclick="$.User.<?php echo $jsMethod?>('<?php echo $join['uid']?>',this,'single');"></a>
					</dt>
					<dd>
						<a href="<?php $this->getTargetHref($archivesHref,true,false)?>"
							title="<?php echo $join['nickname']?>"
        ...
        <div class="rightcon relative">
			...
			<div class="conbox">
				<div class="datecon" id="charmrank_append">
            		<?php $this->renderPartial('application.views.user.charmrank',array('rank'=>$this->viewer['charmRank']));?>
                </div>
			</div>
		</div>
		<p class="rightcon-btm"></p>
		<div class="rightcon relative">
			...
			<div class="conbox">
				<div class="today" id="richrank_append">
                    <?php $this->renderPartial('application.views.user.richrank',array('rank'=>$this->viewer['richRank']));?>
                </div>
			</div>
		</div>
		<p class="rightcon-btm"></p>
		<div class="rightcon relative">
			...
			<div class="conbox">
				<div class="today" id="friendlyrank_append">
                    <?php $this->renderPartial('application.views.user.friendlyrank',array('rank'=>$this->viewer['friendlyRank']));?>
                </div>
			</div>
		</div>
		<p class="rightcon-btm"></p>
