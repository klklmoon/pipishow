    ...
    <div class="fleft sort-l">
    	<div class="topbox-l">
            ...
            <ul class="area-banner">
            	...
            	<li><a class="jukebtn" href="<?php $this->getTargetHref('index.php?r=index/category&type=song')?>"  target="<?php echo $this->target?>" >点唱专区</a></li>
            	<!--  
        ...
        <div class="rankbox mt10" id="leftFansTop">
     	<?php 
    		$this->renderPartial('application.views.channel.categoryleft',array('leftData'=>array())); 
   		?>
        </div><!--.rankbox-->
    ...
    <div class="fright sort-r" id='doteyData'>
    	<div class="satetab clearfix">
         ...
         <div class="satebox mt10">
        	 <?php 
            	$this->renderPartial('application.views.index2.liveArchivesTemplate2',$archives);
            ?>
        </div>
