<?php
/**
 * redis缓存处理，在国外开源的redis库上二次开发
 * 
 * the last known user to change this file in the repository  <$LastChangedBy: suqian $>
 * @author Charles Pick
 * @version $Id: PipiRedisCache.php 8388 2013-04-02 12:58:45Z suqian $ 
 * @package redis
 */
class PipiRedisCache extends CCache {
	/**
	 ...
	 * @param PipiRedisConnection|string $connection the redis connection, if a string is provided, it is presumed to be a the name of an applciation component
	 */
	public function setConnection($connection)
	{
		...
		if(!$connection instanceof  PipiRedisConnection){
			throw new CException("PipiRedisCache expects a 'redis' application component");
		}
