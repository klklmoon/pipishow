 ...
 * Simple usage:
 * <pre>
 * $mutex = new PipiRedisMutex("someOperation");
 ...
 * @author Charles Pick
 * @version $Id: PipiRedisMutex.php 8331 2013-03-29 14:44:24Z suqian $ 
 */
class PipiRedisMutex extends PipiRedisEntity {
	 ...
	 * @return PipiRedisMutex $this after the lock is opened
	 */
