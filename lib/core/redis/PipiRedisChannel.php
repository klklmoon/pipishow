 ...
 */
class PipiRedisChannel extends ARedisIterableEntity {
	/**
	 ...
	 * @return PipiRedisIterableChannel $this subscribed to the channel
	 */
	 ...
	 * @return PipiRedisIterableChannel $this unsubscribed from the channel
	 */
