 ...
 * 
 * @author Charles Pick
 * @version $Id: PipiRedisEntity.php 8331 2013-03-29 14:44:24Z suqian $ 
 */
abstract class PipiRedisEntity extends CBehavior {
	/**
	 ...
	 * @param PipiRedisConnection|string $connection the redis connection to use with this entity
	 */
