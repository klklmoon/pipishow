...
return array(
	'components'=>array(
		...
		'db_partner'=>array(
			'connectionString' =>'mysql:host=10.0.2.77;dbname=lt_partner_db',
			'username' => 'pipiuc',
		 	'password' => 'pipi%77%*(@)db',
			'charset' => 'utf8',
			'emulatePrepare' => true,
		...
		'db_bbs'=>array(
				'connectionString' =>'mysql:host=10.0.2.77;dbname=lt_bbs_db',
				'username' => 'pipiuc',
				'password' => 'pipi%77%*(@)db',
				'charset' => 'utf8',
				'emulatePrepare' => true,
		...
		'db_common'=>array(
				'connectionString' =>'mysql:host=10.0.2.77;dbname=lt_common_db',
				'username' => 'pipiuc',
				'password' => 'pipi%77%*(@)db',
				'charset' => 'utf8',
				'emulatePrepare' => true,
